...
import img from './../../../public/slide2.jpg';
	...
	return (
		<div className="h-full w-full">
			...
			>
				...
				>
					<div
						className={`w-full h-full flex justify-center items-center flex-col fixed top-0 left-0  transition-all duration-1000 ease-in ${
							loaded
								? 'opacity-100 translate-y-0'
								: 'opacity-0 -translate-y-[40%]'
						}`}
					>
						<h1 className="md:text-5xl sm:text-4xl text-2xl font-[700] leading-[1.2]">
							Want To Learn Music
						</h1>
						<h1 className="md:text-5xl sm:text-4xl text-2xl font-[700] leading-[1.2]">
							From The Comfort
						</h1>
						<h1 className="md:text-5xl sm:text-4xl text-2xl font-[700] leading-[1.2] pb-2">
							Of Your Home?
						</h1>
